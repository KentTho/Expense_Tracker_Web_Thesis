    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950 text-slate-200">
        <div className="text-center">
          <div className="mx-auto h-16 w-16 rounded-full border-4 border-cyan-400/20 border-t-cyan-400 animate-spin" />
          <p className="mt-4 text-sm tracking-[0.25em] uppercase text-slate-400">Syncing workspace</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={theme === "dark" ? "dark" : ""}>
      <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(34,211,238,0.18),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(251,146,60,0.15),_transparent_24%)]">
        <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(15,23,42,0.94),rgba(15,23,42,0.78))] dark:block hidden" />
